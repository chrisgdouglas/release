...
.container{max-width:500px;margin:0 auto;padding:2rem 1.5rem;width:100%;background:var(--card);box-shadow:var(--shadow)}
...
button{width:100%;margin-top:1rem;padding:.9rem;font:inherit;font-weight:600;font-size:1rem;color:#fff;background:var(--accent);border:none;border-radius:var(--radius);cursor:pointer;transition:background .2s,box-shadow .2s;box-shadow:0 2px 4px rgba(33,150,243,.25)}
